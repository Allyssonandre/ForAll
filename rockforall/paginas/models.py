...
class Postagem(models.Model):
	titulo         = models.CharField(max_length=100,verbose_name='TÍTULO DA POSTAGEM',null=False,blank=False)
	CATEGORIA = [
	('Música','Música'),
	('Cinema','Cinema'),
	('Dica','Dica'),
	...
	categoria      = models.CharField(max_length=30,choices=CATEGORIA,verbose_name='CATEGORIA',null=False,blank=False)
	imagem_do_post = models.ImageField(upload_to='media/posts',verbose_name='IMAGEM DA POSTAGEM',null=False,blank=False)
	comenta        = models.TextField(max_length=100, verbose_name='COMENTE: no máximo 150 caracteres',null=False,blank=False)
...
class VideosCurtos(models.Model):
	titulo   = models.CharField(max_length=100, verbose_name='TÍTULO DO VÍDEO',null=False,blank=False)
	CATEGORIA = [
	('Indicação','Indicação'),
	('YouTube','YouTube'),
	('Outros','Outros'),
	]
	categoria = models.CharField(max_length=30,choices=CATEGORIA,verbose_name='CATEGORIA DO VÍDEOS',null=False,blank=False)
	video    = EmbedVideoField(verbose_name='LINK DO VÍDEO',null=False,blank=False)
	comenta   = models.TextField(max_length=120,null=True,blank=True,verbose_name='COMENTE SOBRE ESTE VÍDEO')
	post_views= models.IntegerField(default=0, null=True,blank=True)
...
class Comentario(models.Model):
	...
	comente     = models.TextField(max_length=100, verbose_name="Comente: no máximo 100 caracteres",null=False,blank=False)
...
class Perfil(models.Model):
	...
	bairro = models.CharField(max_length=40,null=False,blank=False)
	cidade = models.CharField(max_length=40,null=False,blank=False)
	uf     = models.CharField(max_length=2,null=False,blank=False)
	image  = models.ImageField(upload_to='media/perfil', default='media/forall.png',null=False,blank=False, verbose_name='IMAGEM PERFIL :')
	escolaridade = models.CharField(max_length=30,verbose_name='ESCOLARIDADE',null=False,blank=False) 
	termos   = models.CharField(max_length=4,verbose_name='TERMO DE USO E POLÍTICA DE PRIVACIDADE',null=False,blank=False)
...
class Momentos(models.Model):
	...
	img1      = models.ImageField(upload_to='media/stories',null=False,blank=False, verbose_name='IMAGEM 1')
	img2      = models.ImageField(upload_to='media/stories',null=False, blank=False, verbose_name='IMAGEM 2')
	descrever  = models.TextField(max_length=100, verbose_name="DESCREVA: NO MÁXIMO 100 CARACTERES",null=True,blank=True)
...
class Eccommence(models.Model):
	...
	titulo_produto= models.CharField(max_length=20,null=False,blank=False,verbose_name='DESCREVA EM 20 CARACTERES QUAL O NOME DO PRODUTO')
	CATEGORIA_PRODUTO = [
	('CD','CD'),
	('Camisa','Camisa'),
	('Bottons','Bottons'),
	...
	estado_produto   = models.CharField(max_length=32,choices=ESTADO_PRODUTO,null=False,blank=False,verbose_name='COMO ESTA O PRODUTO ?')
	...
	image_produto    = models.ImageField(upload_to='media/Eccommence',null=False,blank=False, verbose_name='IMAGE DO PRODUTO. TAMANHO RECOMENDADO EX: 200 X 200:')
...
class Pensamento(models.Model):
	user      = models.ForeignKey(User,null=True,blank=True,on_delete=models.CASCADE,verbose_name='Postado por:')
	ideia     = models.TextField(null=False,blank=False, verbose_name='O que você esta pensando ? Post suas idéias.')
...
class ComentaPosts(models.Model):
	...
	comentarios = models.TextField(max_length=50,verbose_name="MENOS DE 20 CARACTERES:",null=False,blank=False)
	RATE_CHOICES = [
	(1,'1 - Gostei'),
	(2,'2 - Não gostei'),
	(3,'3 - Boa dica'),
