...
class MomentosHistoria(forms.ModelForm):
	class Meta:
		model  = Momentos
		fields = 'momento','img1','img2','descrever'
...
class EccommenceForm(forms.ModelForm):
	...
	class Meta:
		model  = Eccommence
		fields = 'nome','titulo_produto','categori_produto','tipo_transacao','cep','rua','bairro','cidade','uf','cartao','estado_produto','preco_produto','contato','image_produto','descrever_produto'
